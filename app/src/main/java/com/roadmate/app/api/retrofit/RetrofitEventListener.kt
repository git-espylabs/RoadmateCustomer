...
import com.roadmate.app.api.rx.RxBus
import okhttp3.*
...
class RetrofitEventListener: EventListener(){
    ...
    override fun callFailed(call: Call, ioe: IOException) { RxBus.send(CallStateEvent(
        RetrofitEvents.CallState.STATE_CALL_FAILURE
    )) }
