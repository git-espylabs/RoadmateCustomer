...
import com.roadmate.app.utils.compressImageFile
...
class SellHereTabFragment: Fragment(), View.OnClickListener {
    ...
    private fun getMyProductsList(){
        ...
        lifecycleScope.launch {
            ...
            if (response.isSuccessful && response.body()?.data!!.isNotEmpty()){
                ...
                sellHereRecycler.visibility = View.VISIBLE
    ...
    private fun multiPartRequest(){
        try {
            val userId = createFormData("userid", UserDetails().userId)
            ...
            val productCategory = createFormData("category", (category_spinner.selectedItemPosition + 1).toString())
            val userType = createFormData("usertype", "1")
